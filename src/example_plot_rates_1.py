...
class Plot_sSNRL(object):
    ...
    Description:
    ------------
    Makes the Fig. 2 of the DTD paper, displaying SN rate (per unit of
    luminosity) as a function of Dcolor. 2 panels are included, showing the
    impact of choosing different star formation histories (exponential--left
    panel or delayed-exponential--right panel). Similarly, this replicates
    Fig. 3 in Heringer+ 2017.
